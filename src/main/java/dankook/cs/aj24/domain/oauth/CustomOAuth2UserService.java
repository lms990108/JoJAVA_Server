...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        Optional<UserDocument> byEmail = userRepository.findByEmail(email);
        UserDocument user = byEmail.orElseGet(() -> saveSocialUser(name, profileImg, email));
    ...
    public UserDocument saveSocialUser(String name, String profileImg, String email) {
